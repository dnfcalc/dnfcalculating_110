<script lang="tsx">
    ...
    import { defineComponent, PropType, ref, renderList, Transition } from "vue"
        ...
        setup(props) {
            ...
            return () => (
                <div class="i-tree-item">
                    <NItem value={props.value} style={`padding-left:${props.depth}rem`} class="i-tree-item-label" onClick={open}>
                        {props.label}
                    </NItem>
