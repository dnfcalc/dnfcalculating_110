      ...
      return (
        <div class="my-1 overflow-hidden h-auto rounded bg-hex-#00000078 border-1 border-hex-#ffffff28">
          <div
            onClick={collapse}
            v-text={props.title}
            class="bg-gradient-to-b to-hex-#122438 from-hex-#244281 w-full h-6 text-xs text-center items-center justify-center flex"
          ></div>
          <div
            class={["transition-all", "ease-in-out", "h-auto"].concat(
