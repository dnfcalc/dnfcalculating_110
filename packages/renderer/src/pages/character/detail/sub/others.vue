        ...
        <div class="flex flex-wrap equ-profile">
          <div class="equ-profile-item">
            ...
            <calc-select v-model={mxtLV.value} class="!h-20px flex-1">
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "冒险团") ?? [], item => (
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={gh.value} class="!h-20px flex-1">
              ...
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "工会属性") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={gh_buff_SW.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "工会buff-攻击力") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
            ...
            <calc-select v-model={gh_buff_GJ.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "工会buff-四维强化") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={HF.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "婚房") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
            ...
            <calc-select v-model={HJ.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "婚戒") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={JTQY.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "晶体契约") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={SJX_TYPE.value} emptyLabel="种类" class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "收集箱") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={XZ_TYPE.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "勋章") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={MCZBK.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.sundries?.filter(item => item.position == "名称装扮卡") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
          ...
          <div class="equ-profile-item">
            ...
            <calc-select v-model={KJZB.value} class="!h-20px flex-1">
              <calc-option value="0">无</calc-option>
              {renderList(basicInfoStore.details?.enchanting?.filter(item => item.position == "快捷装备") ?? [], item => (
                <calc-option value={item.id}>{item.props}</calc-option>
              ))}
            </calc-select>
          </div>
