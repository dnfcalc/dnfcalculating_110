...
class 技能5(职业主动技能):
    ...
    data0 = [655, 722, 788, 853, 920, 987, 1053, 1120, 1186, 1253, 1319, 1386, 1453, 1519, 1586, 1651, 1718, 1784, 1851, 1917, 1984, 2050, 2117, 2184, 2250, 2317, 2383, 2449, 2515, 2582, 2648, 2715, 2781, 2848, 2915,
    ...
    def 等效百分比(self, **argv):
        ...
        if 伤害类型 == "直伤":
            等效倍率 = 0.0
            等级 = min(self.等级 + 额外等级, len(self.data0))
            等效倍率 += self.data0[等级] * self.hit0 * self.power0
            return 等效倍率 * (1 + self.TP成长 * self.TP等级) * self.倍率 * 额外倍率
        elif 伤害类型 == "感电":
            等效倍率 = 0.0
            等级 = min(self.等级 + 额外等级, len(self.data0))
            等效倍率 += self.data1[等级] * self.hit1 * self.power1
            return 等效倍率 * (1 + self.TP成长 * self.TP等级) * self.倍率 * 额外倍率
        else:
            return 0
