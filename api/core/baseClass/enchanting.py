...
def enchanting_21465(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '智(20)|火强(7)')"
    if mode == 0:
        char.基础属性加成(智力=20 * rate)
        char.火属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21466(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '体(20)|物攻(15)')"
    if mode == 0:
        char.基础属性加成(体力=20 * rate)
        char.基础属性加成(物理攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21467(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '体(20)|魔攻(15)')"
    if mode == 0:
        char.基础属性加成(体力=20 * rate)
        char.基础属性加成(魔法攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21468(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '精(20)|物攻(15)')"
    if mode == 0:
        char.基础属性加成(精神=20 * rate)
        char.基础属性加成(物理攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21469(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '精(20)|魔攻(15)')"
    if mode == 0:
        char.基础属性加成(精神=20 * rate)
        char.基础属性加成(魔法攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21470(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '物攻(15)|独立(25)')"
    if mode == 0:
        char.基础属性加成(物理攻击力=15 * rate)
        char.基础属性加成(独立攻击力=25 * rate)
    if mode == 1:
...
def enchanting_21471(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '魔攻(15)|独立(25)')"
    if mode == 0:
        char.基础属性加成(魔法攻击力=15 * rate)
        char.基础属性加成(独立攻击力=25 * rate)
    if mode == 1:
...
def enchanting_21472(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '独立(25)|物暴(3%)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.基础属性加成(物理暴击率=0.03 * rate)
    if mode == 1:
...
def enchanting_21473(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(139, '宠物', '独立(25)|魔暴(3%)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.基础属性加成(魔法暴击率=0.03 * rate)
    if mode == 1:
...
def enchanting_21474(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '独立(25)|火强(7)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.火属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21475(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '独立(25)|冰强(7)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.冰属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21476(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '独立(25)|暗强(7)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.暗属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21477(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '独立(25)|光强(7)')"
    if mode == 0:
        char.基础属性加成(独立攻击力=25 * rate)
        char.光属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21478(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '物暴(3%)|火强(7)')"
    if mode == 0:
        char.基础属性加成(物理暴击率=0.03 * rate)
        char.火属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21479(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '物暴(3%)|冰强(7)')"
    if mode == 0:
        char.基础属性加成(物理暴击率=0.03 * rate)
        char.冰属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21480(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '物暴(3%)|暗强(7)')"
    if mode == 0:
        char.基础属性加成(物理暴击率=0.03 * rate)
        char.暗属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21481(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '物暴(3%)|光强(7)')"
    if mode == 0:
        char.基础属性加成(物理暴击率=0.03 * rate)
        char.光属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21482(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '魔暴(3%)|火强(7)')"
    if mode == 0:
        char.基础属性加成(魔法暴击率=0.03 * rate)
        char.火属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21483(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '魔暴(3%)|冰强(7)')"
    if mode == 0:
        char.基础属性加成(魔法暴击率=0.03 * rate)
        char.冰属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21484(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '魔暴(3%)|暗强(7)')"
    if mode == 0:
        char.基础属性加成(魔法暴击率=0.03 * rate)
        char.暗属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21485(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(148, '宠物', '魔暴(3%)|光强(7)')"
    if mode == 0:
        char.基础属性加成(魔法暴击率=0.03 * rate)
        char.光属性强化加成(7 * rate)
    if mode == 1:
...
def enchanting_21486(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(56, '下装', '物攻(15)|魔攻(15)')"
    if mode == 0:
        char.基础属性加成(物理攻击力=15 * rate)
        char.基础属性加成(魔法攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21487(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(69, '下装', '物攻(24)|魔攻(24)')"
    if mode == 0:
        char.基础属性加成(物理攻击力=24 * rate)
        char.基础属性加成(魔法攻击力=24 * rate)
    if mode == 1:
...
def enchanting_21488(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(56, '上衣', '物攻(15)|魔攻(15)')"
    if mode == 0:
        char.基础属性加成(物理攻击力=15 * rate)
        char.基础属性加成(魔法攻击力=15 * rate)
    if mode == 1:
...
def enchanting_21489(char: Character = {}, mode=0, text=False, rate=1.0):
    if text:
        return "(69, '上衣', '物攻(24)|魔攻(24)')"
    if mode == 0:
        char.基础属性加成(物理攻击力=24 * rate)
        char.基础属性加成(魔法攻击力=24 * rate)
    if mode == 1:
