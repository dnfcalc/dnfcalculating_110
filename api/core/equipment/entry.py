...
def entry_1254(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['根据穿戴的所有装备的品级百分比总和适用以下效果：', '- 800%以上：移动速度 +5%', '- 900%以上：攻击速度 +5%，施放速度 +7.5%', '- 1000%以上：物理、魔法暴击率 +5%', '- 1150%以上：技能攻击力 +5%']
    if mode == 0:
        pass
    if mode == 1:
        char.技能攻击力加成(0.05)
...
def entry_930(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['攻击时，敌人的异常数量增加时，攻击强化 +889(最多叠加3次)']
    if mode == 0:
        pass
    if mode == 1:
...
def entry_139(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个出血状态的敌人，攻击强化 +356(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
...
def entry_140(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个中毒状态的敌人，攻击强化 +356(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        char.攻击强化加成(成长词条计算(356, lv) * min(10, enemy_num)
...
def entry_141(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个灼伤状态的敌人，攻击强化 +356(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        char.攻击强化加成(成长词条计算(356, lv) * min(10, enemy_num)
...
def entry_142(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个感电状态的敌人，攻击强化 +356(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        char.攻击强化加成(成长词条计算(356, lv) * min(10, enemy_num)
...
def entry_143(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个冰冻状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_144(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个减速状态的敌人，攻击强化 + 385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_145(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个眩晕状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_146(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个诅咒状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_147(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个失明状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_148(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个石化状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_149(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个睡眠状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_150(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个混乱状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
...
def entry_151(char: Character = {}, mode=0, text=False, part='', lv=0):
    if text:
        return ['500px范围内，每存在1个束缚状态的敌人，攻击强化 +385(最多叠加10次)']
    if mode == 0:
        pass
    if mode == 1:
        攻击强化 = 成长词条计算(385, lv)
